...
# BP measurement Max(Psa)/Min(Psa), EF LV, EF RV, EF LA, EF RA, Max(Qs), Max(Qp)
...
#save("3B_D.jld", "data", res)

res = load("/home/harry/Desktop/PhD/Year 3/Measurement Project/Discrete Levels/Level 3/3B/3B_D.jld")["data"]
...
@show P[29], P[28], P[3], P[22], P[2], P[14], P[1], P[31], P[8], P[11], P[33], P[34], P[13], P[4]
...
save("/home/harry/Desktop/PhD/Year 3/Measurement Project/Sloppiness Plot/Dis_levels/3b.jld","data",λ)