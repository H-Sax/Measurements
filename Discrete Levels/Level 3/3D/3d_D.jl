...
# BP measurement Max(Psa)/Min(Psa), EF LV, EF RV, EF LA, EF RA, Max(Qs), Max(Qp), Max(Qav), Max(Qmv)
...
#save("3D_D.jld", "data", res)

res = load("/home/harry/Desktop/PhD/Year 3/Measurement Project/Discrete Levels/Level 3/3D/3D_D.jld")["data"]
...
@show P[29], P[28], P[3], P[4], P[22], P[2], P[14], P[8], P[11], P[31], P[1], P[33], P[13], P[34]
...
save("/home/harry/Desktop/PhD/Year 3/Measurement Project/Sloppiness Plot/Dis_levels/3d.jld","data",λ)