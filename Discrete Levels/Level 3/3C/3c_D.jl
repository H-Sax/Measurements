...
# BP measurement Max(Psa)/Min(Psa), EF LV, EF RV, EF LA, EF RA, Max(Qs), Max(Qp), Max(Qav)
...
circ_time_idxs_chunked = function (p)
    ...
    for k in 1:chunks
        ...
        @time "    Results processed in" Threads.@threads for i in 1:chunksize
          ...
          out[8,i+offset] = maximum(sol[i][PA.R.q]) #  Maximum aortic valve flow
...
#save("3C_D.jld", "data", res)

res = load("/home/harry/Desktop/PhD/Year 3/Measurement Project/Discrete Levels/Level 3/3C/3C_D.jld")["data"]
...
@show P[29], P[28], P[3], P[22], P[2], P[33], P[34], P[14], P[11], P[8], P[31], P[1], P[13], P[19]
...
save("/home/harry/Desktop/PhD/Year 3/Measurement Project/Sloppiness Plot/Dis_levels/3c.jld","data",λ)