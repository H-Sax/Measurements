...
# BP measurement Max(Psa)/Min(Psa), EF LV, EF RV, EF LA, EF RA
...
#save("Level3D.jld", "data", res)

res = load("/home/harry/Desktop/PhD/Year 3/Measurement Project/Discrete Levels/Level 2/2D/Level2D_D.jld")["data"]
...
@show P[22], P[29], P[28], P[3], P[19], P[16], P[13], P[14], P[1]
...
save("/home/harry/Desktop/PhD/Year 3/Measurement Project/Sloppiness Plot/Dis_levels/2d.jld","data",λ)