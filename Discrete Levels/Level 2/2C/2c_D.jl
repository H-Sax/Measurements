...
# BP measurement Max(Psa)/Min(Psa), EF LV, EF RV, EF LA
...
#save("Level3C.jld", "data", res)

res = load("/home/harry/Desktop/PhD/Year 3/Measurement Project/Discrete Levels/Level 2/2C/Level2C_D.jld")["data"]
...
@show P[29], P[28], P[3], P[1], P[14], P[4]
...
save("/home/harry/Desktop/PhD/Year 3/Measurement Project/Sloppiness Plot/Dis_levels/2c.jld","data",λ)