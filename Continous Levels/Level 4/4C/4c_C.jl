...
# cont(Qs), cont(Qp), cont(Qav), cont(Qmv), cont(Qpv), cont(Qtv), cont(Vlv), cont(Vrv), cont(Vla), cont(Vra), cont(Plv), cont(Psa),    cont(Prv), cont(Ppa), cont(Pra)
...
#save("4c_C.jld", "data", res)

res = load("/home/harry/Desktop/PhD/Year 3/Measurement Project/Continous Levels/Level 4/4C/4c_C.jld")["data"]
...
show(p)
#Parameters
@show P[22], P[13], P[2], P[29], P[31], P[11], P[18], P[16], P[5], P[14], P[15], P[19], P[7], P[3], P[36], P[33], P[4], P[34], P[28]
...
save("/home/harry/Desktop/PhD/Year 3/Measurement Project/Sloppiness Plot/Con_Levels/4c.jld","data",λ)