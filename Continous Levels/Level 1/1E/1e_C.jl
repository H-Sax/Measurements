...
# cont(Qs), cont(Qp), cont(Qav), cont(Qmv), cont(Qpv)
...
#save("1e_C.jld", "data", res)

res = load("/home/harry/Desktop/PhD/Year 3/Measurement Project/Continous Levels/Level 1/1E/1e_C.jld")["data"]
...
show(p)
#Parameters
@show P[11], P[5], P[2], P[4], P[15], P[29], P[33], P[7], P[31], P[8], P[34], P[28], P[3], P[36], P[13], P[22]
...
save("/home/harry/Desktop/PhD/Year 3/Measurement Project/Sloppiness Plot/Con_Levels/1e.jld","data",λ)