...
save("1b_C.jld", "data", res)

res = load("/home/harry/Desktop/PhD/Year 3/Measurement Project/Continous Levels/Level 1/1B/1b_C.jld")["data"]
#
...
show(p)
#Parameters
@show P[2], P[11], P[29], P[33], P[31], P[28], P[34], P[15], P[36], P[3], P[4], P[22], P[13], P[8], P[14], P[5], P[7], P[19], P[30]
...
save("/home/harry/Desktop/PhD/Year 3/Measurement Project/Sloppiness Plot/Con_Levels/1b.jld","data",λ)