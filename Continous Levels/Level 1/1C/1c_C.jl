...
#save("1c_C.jld", "data", res)

res = load("/home/harry/Desktop/PhD/Year 3/Measurement Project/Continous Levels/Level 1/1C/1c_C.jld")["data"]
...
show(p)
#Parameters
@show P[4], P[2], P[29], P[28], P[3], P[11], P[31], P[33], P[36], P[34], P[22], P[15], P[13], P[5], P[8]
...
save("/home/harry/Desktop/PhD/Year 3/Measurement Project/Sloppiness Plot/Con_Levels/1c.jld","data",λ)