...
# cont(Qs), cont(Qp), cont(Qav), cont(Qmv), cont(Qpv), cont(Qtv)
...
#save("1f_C.jld", "data", res)

res = load("/home/harry/Desktop/PhD/Year 3/Measurement Project/Continous Levels/Level 1/1F/1f_C.jld")["data"]
...
show(p)
#Parameters
@show P[11], P[22], P[5], P[2], P[15], P[4], P[16], P[29], P[33], P[31], P[34], P[7], P[13], P[8], P[3], P[28], P[36]
...
save("/home/harry/Desktop/PhD/Year 3/Measurement Project/Sloppiness Plot/Con_Levels/1f.jld","data",λ)