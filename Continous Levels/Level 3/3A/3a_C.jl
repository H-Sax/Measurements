...
# cont(Qs), cont(Qp), cont(Qav), cont(Qmv), cont(Qpv), cont(Qtv), cont(Vlv), cont(Vrv), cont(Vla), cont(Vra), cont(Plv)
...
#save("3a_C.jld", "data", res)

res = load("/home/harry/Desktop/PhD/Year 3/Measurement Project/Continous Levels/Level 3/3A/3a_C.jld")["data"]
...
show(p)
#Parameters
@show P[5], P[2], P[22], P[11], P[7], P[4], P[3], P[31], P[13], P[29], P[14], P[36], P[28], P[15], P[33], P[8], P[16], P[18], P[19]
...
save("/home/harry/Desktop/PhD/Year 3/Measurement Project/Sloppiness Plot/Con_Levels/3a.jld","data",λ)