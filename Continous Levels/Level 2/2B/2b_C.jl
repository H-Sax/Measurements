...
# cont(Qs), cont(Qp), cont(Qav), cont(Qmv), cont(Qpv), cont(Qtv), cont(Vlv), cont(Vrv)
...
#save("2b_C.jld", "data", res)

res = load("/home/harry/Desktop/PhD/Year 3/Measurement Project/Continous Levels/Level 2/2B/2b_C.jld")["data"]
...
show(p)
#Parameters
@show P[5], P[22], P[11], P[2], P[15], P[4], P[16], P[3], P[31], P[29], P[14], P[33], P[13], P[28], P[36], P[7]
...
save("/home/harry/Desktop/PhD/Year 3/Measurement Project/Sloppiness Plot/Con_Levels/2b.jld","data",λ)