...
# cont(Qs), cont(Qp), cont(Qav), cont(Qmv), cont(Qpv), cont(Qtv), cont(Vlv), cont(Vrv), cont(Vla)
...
#save("2c_C.jld", "data", res)

res = load("/home/harry/Desktop/PhD/Year 3/Measurement Project/Continous Levels/Level 2/2C/2c_C.jld")["data"]
#
...
show(p)
#Parameters
@show P[11], P[5], P[2], P[22], P[7], P[3], P[4], P[31], P[15], P[29], P[8], P[14], P[33], P[28], P[36], P[13], P[16], P[34]
...
save("/home/harry/Desktop/PhD/Year 3/Measurement Project/Sloppiness Plot/Con_Levels/2c.jld","data",λ)