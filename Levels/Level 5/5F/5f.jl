...
# BP measurement Max(Psa)/Min(Psa), EF LV, EF RV, EF LA, EF RA, Qs cont, Qp cont, Qav cont, Qmv cont, Qpv cont, Qtv cont, Max(Qav),     Max(Qmv), Max(Qpv), Max(Qtv), cont(Vlv), cont(Vrv)
...
#save("Level5F.jld", "data", res)

res = load("/home/harry/Desktop/PhD/Year 3/Measurement Project/Levels/Level 5/5F/Level5F.jld")["data"]
...
save("/home/harry/Desktop/PhD/Year 3/Measurement Project/Sloppiness Plot/5f.jld","data",λ)
