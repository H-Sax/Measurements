...
# BP measurement Max(Psa)/Min(Psa), EF LV, EF RV, EF LA, EF RA, Qs cont, Qp cont, Qav cont, Qmv cont, Qpv cont, Qtv cont, Max(Qav),     Max(Qmv)
...
#save("Level5B.jld", "data", res)

res = load("/home/harry/Desktop/PhD/Year 3/Measurement Project/Levels/Level 5/5B/Level5B.jld")["data"]
...
save("/home/harry/Desktop/PhD/Year 3/Measurement Project/Sloppiness Plot/5b.jld","data",λ)
