...
# BP measurement Max(Psa)/Min(Psa), EF LV, EF RV, EF LA, EF RA, Qs cont, Qp cont, Qav cont, Qmv cont, Qpv cont, Qtv cont, Max(Qav),     Max(Qmv), Max(Qpv)
...
#save("Level5C.jld", "data", res)

res = load("/home/harry/Desktop/PhD/Year 3/Measurement Project/Levels/Level 5/5C/Level5C.jld")["data"]
