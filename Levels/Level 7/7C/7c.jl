...
# BP measurement Max(Psa)/Min(Psa), EF LV, EF RV, EF LA, EF RA, Qs cont, Qp cont, Qav cont, Qmv cont, Qpv cont, Qtv cont, Max(Qav),     Max(Qmv), Max(Qpv), Max(Qtv), cont(Vlv), cont(Vrv), cont(Vla), cont(Vra), cont(Plv), cont(Psa), cont(Prv), cont(Ppa), cont(Pra)
...
#save("Level7C.jld", "data", res)

res = load("/home/harry/Desktop/PhD/Year 3/Measurement Project/Levels/Level 7/7C/Level7C.jld")["data"]
