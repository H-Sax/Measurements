...
# BP measurement Max(Psa)/Min(Psa), EF LV, EF RV, EF LA, EF RA, Qs cont, Qp cont
...
#save("Level4B.jld", "data", res)

res = load("/home/harry/Desktop/PhD/Year 3/Measurement Project/Levels/Level 4/4B/Level4B.jld")["data"]
...
save("/home/harry/Desktop/PhD/Year 3/Measurement Project/Sloppiness Plot/4b.jld","data",λ)
x = ones(36)
y = λ
